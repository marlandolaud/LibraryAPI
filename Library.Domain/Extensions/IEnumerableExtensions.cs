namespace Library.Domain.Extensions
{
    ...
    {
        public static IEnumerable<ExpandableObject> ShapeData<TSource>(this IEnumerable<TSource> source, string fields)
        {
            if (source == null)
            {
            ...
            var result = new List<ExpandableObject>();
            ...
            {
                var dataShapedObject = new ExpandableObject();
