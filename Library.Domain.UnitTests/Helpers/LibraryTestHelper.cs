...
namespace Library.Domain.UnitTests.Helpers
{
    public static class LibraryTestHelper
    {
                ...
                new Author()
                {
                     ...
                     Books = new List<Book>()
                     {
                         new Book()
                         {
                             ...
                             Title = "American Gods",
                             Description = "American Gods is a Hugo and Nebula Award-winning novel by English author Neil Maiman. The novel is a blend of Americana, fantasy, and various strands of ancient and modern mythology, all centering on the mysterious and taciturn Shadow."
                         }
                     }
                },
                new Author()
                {
                     ...
                     Books = new List<Book>()
                     {
                         new Book()
                         {
                             ...
                             Title = "Speechless",
                             Description = "Good-natured and often humorous, Speechless is at times a 'song of curses', as Annoyer describes the conflicts with his beloved diva of a mother and her brave struggle with decline and death."
                         }
                     }
                },
                new Author()
                ...
                new Author()
                {
                     ...
                     Books = new List<Book>()
                     {
                         new Book()
                         {
                             ...
                             Title = "Easy Money",
                             Description = "Easy Money or Snapback cash is a novel from 2006 by Jens Lepidus. It has been a success in term of sales, and the paperback was the fourth best seller of Swedish novels in 2007."
                         }
                     }
                }
            };
